...
func main() {
	...
	hostRegistry.Register("Parent-Generalist-30B", modelhost.NewPromptHost("local-parent-host"))
	hostRegistry.Register("Image-Analysis-Specialist-01", modelhost.NewAssetSummaryHost("local-image-host", "image"))
	hostRegistry.Register("Audio-Transcription-Specialist-01", modelhost.NewAssetSummaryHost("local-audio-host", "audio"))
	hostRegistry.Register("Video-Understanding-Specialist-01", modelhost.NewAssetSummaryHost("local-video-host", "video"))
