...
- `scripts/bootstrap_verify_db.sh` now applies `sql/20260421_route_episodes.sql`.
- `README.md` now includes the new route-episode migration in the bootstrap list.
- `docs/implementation-status.md` now records the unit-bootstrap change, compatibility unit-target routing, and initial route-episode persistence.
